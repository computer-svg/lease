...
public class RoomController {
    ...
    @Autowired
    private RoomInforService roomInforService;

    @Operation(summary = "保存或更新房间信息")
    @PostMapping("saveOrUpdate")
    public Result saveOrUpdate(@RequestBody RoomSubmitVo roomSubmitVo) {

        roomInforService.saveOrUpdateRoom(roomSubmitVo);
        return Result.ok();
    }
    ...
    public Result<IPage<RoomItemVo>> pageItem(@RequestParam long current, @RequestParam long size, RoomQueryVo queryVo) {
        ...
        IPage<RoomItemVo> result = roomInforService.pageRoomItemByQuery(page, queryVo);
    ...
    public Result<RoomDetailVo> getDetailById(@RequestParam Long id) {
        ...
        RoomDetailVo roomDetailVo = roomInforService.getRoomDetailById(id);
    ...
    public Result removeById(@RequestParam Long id) {
        roomInforService.removeById(id);
        return Result.ok();
    }
    ...
    public Result updateReleaseStatusById(Long id, ReleaseStatus status) {
        ...
        roomInforService.update(updateWrapper);
        return Result.ok();
    }
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        ...
        List<RoomInfo> list = roomInforService.list(queryWrapper);
