package com.tc.lease.web.admin.controller.system;
...
import com.tc.lease.model.enums.BaseStatus;
...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
       ...
       IPage<SystemUserItemVo> list = systemUserService.pageSystemUserItemByQuery(page, queryVo);
    ...
    public Result<SystemUserItemVo> getById(@RequestParam Long id) {
        SystemUserItemVo systemUserItemVo = systemUserService.getSystemUserItemById(id);
